...
export default function ProfileGudang() {
  ...
  const activities = [
    ...
    { time: "09:40", text: "Stok BRG-002 menipis (Gudang)" },
    { time: "Kemarin", text: "Update pengiriman" },
  ];
    ...
    <div className="pageAdmin pageAdmin--wide">
      ...
      >
        <div className="profileHero__left">
          <div className="profileHero__avatar">G</div>

          <div className="profileHero__meta">
            <div className="profileHero__titleRow">
              <h1 className="profileHero__title">Profile Gudang</h1>
              <span className="profileHero__badge">GUDANG</span>
            ...
            <p className="profileHero__subtitle">
              Kelola informasi akun gudang, preferensi notifikasi, dan aktivitas operasional.
            </p>

            <div className="profileHero__quick">
              <button className="profileBtn profileBtn--primary" type="button">Edit Profil</button>
              <button className="profileBtn" type="button">Ubah Password</button>
              <button className="profileBtn profileBtn--ghost" type="button">Lihat Aktivitas</button>
            </div>
          </div>
        </div>
        ...
        <div className="profileHero__right">
          {stats.map((s) => (
            <motion.div key={s.label} whileHover={{ y: -2 }} transition={{ duration: 0.18, ease: easing }}>
      ...
      >
        <Card className="profileCard">
          <div className="profileCard__head">
            <h3>Data Akun</h3>
            <span className="profileCard__hint">Informasi pengguna</span>
          </div>

          <div className="profileRows">
            <div className="profileRow"><span>Nama</span><b>Gudang</b></div>
            <div className="profileRow"><span>Email</span><b>gudang@gmail.com</b></div>
            <div className="profileRow"><span>Role</span><b>Gudang</b></div>
            <div className="profileRow"><span>Terakhir Login</span><b>Hari ini</b></div>
          </div>

          <div className="profileActions">
            <button className="profileBtn profileBtn--primary" type="button">Simpan Perubahan</button>
            <button className="profileBtn profileBtn--ghost" type="button">Batalkan</button>
          </div>
        </Card>
          ...
          <div className="prefList">
            <label className="prefItem">
              <div className="prefItem__text">
                ...
                <div className="prefItem__sub">Muncul ketika stok melewati batas minimum</div>
              </div>
            ...
            <div className="prefCTA">
              <button className="profileBtn profileBtn--primary" type="button">Terapkan</button>
              <button className="profileBtn" type="button">Reset</button>
            </div>
          </div>
        </Card>
        ...
        <Card className="profileCard profileCard--full">
          <div className="profileCard__head">
            ...
            <span className="profileCard__hint">Log ringkas</span>
          </div>
          ...
          <div className="activityList">
            {activities.map((a, i) => (
              ...
              >
                ...
                <button className="activityItem__btn" type="button">Detail</button>
              </motion.div>
            ))}
          </div>
        </Card>
